...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_EQL, KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_PSCR, KC_MPLY, KC_N, KC_M, KC_COMM, KC_DOT, KC_LBRC, KC_RBRC, KC_LCTL, KC_LALT, KC_LGUI, KC_ENT, KC_SPC, KC_BSPC, TG(1), KC_SLSH),
	[1] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_TAB, KC_PGUP, KC_UP, KC_PGDN, KC_BRIU, KC_BRID, KC_PDOT, KC_P7, KC_P8, KC_P9, KC_NO, KC_INS, KC_ESC, KC_LEFT, KC_DOWN, KC_RGHT, KC_PSLS, KC_PAST, KC_PCMM, KC_P4, KC_P5, KC_P6, KC_NO, KC_HOME, KC_LSFT, KC_DEL, KC_NO, KC_NO, KC_PPLS, KC_PMNS, KC_PSCR, KC_MPLY, KC_P0, KC_P1, KC_P2, KC_P3, KC_NO, KC_END, KC_LCTL, KC_LALT, KC_LGUI, KC_ENT, KC_SPC, KC_BSPC, TG(1), KC_PENT)
};
