...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_PGUP, KC_UP, KC_PGDN, KC_BRIU, KC_BRID, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_PMNS, KC_INS, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PAST, KC_PSLS, KC_HOME, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_DEL, KC_PSCR, KC_MPLY, KC_P1, KC_P2, KC_P3, KC_PEQL, KC_PCMM, KC_END, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC, KC_ENT, TG(0), KC_P0, KC_PDOT)
};
